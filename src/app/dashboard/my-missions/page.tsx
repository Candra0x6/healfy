...
import AchivmentPart from "@/components/mission-element/AchivmentPart";
import DailyCheckin from "@/components/mission-element/DailyCheckin";
import DailyGuest from "@/components/mission-element/DailyGuest";
import {
  detailAchievements,
  detailCheckIn,
  detailMissions,
} from "@/libs/fetch/mission";
  ...
  return (
    <>
      ...
      <div className="grid md:grid-cols-2 grid-cols-1 gap-4">
        <div className="col-span-1 gap-4 bg-card p-8 space-y-4 rounded-xl shadow-md shadow-foreground/20">
        ...
        <div className="md:col-span-1 bg-card rounded-xl p-8 shadow-md shadow-foreground/20 ">
          <h1 className="font-bold text-2xl mb-5">Daily checkin 🫡</h1>
          <Suspense fallback={<div>Loading...</div>}>
            <DailyCheckin data={checkin} />
          </Suspense>
        </div>
        <div className="md:col-span-2 bg-card w-full h-full rounded-xl shadow-md shadow-foreground/20 ">
          <Suspense fallback={<div>Loading...</div>}>
